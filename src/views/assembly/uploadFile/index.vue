	...
	<div class="upload content-box">
		...
		<div class="card img-box">
			...
			<el-descriptions title="配置项 📚" :column="1" border>
				...
				<el-descriptions-item label="api"> 上传图片的 api 方法，一般项目上传都是同一个 api 方法，在组件里直接引入即可（非必传） </el-descriptions-item>
		...
		<div class="form-box">
			...
			<div class="card">
				<el-alert title="图片上传组件在 form 表单中使用，如果该表单禁用，则上传组件会自动禁用" type="warning" effect="dark" :closable="false" class="mb20" />
