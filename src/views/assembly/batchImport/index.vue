<template>
	<div class="card content-box">
		...
		<el-descriptions title="配置项（通过 ref 传递） 📚" :column="1" border>
			...
			<el-descriptions-item label="fileType"> 上传文件类型限制，默认类型为 ["application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"] </el-descriptions-item>
